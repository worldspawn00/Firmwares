...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_soldered(
      ...
      KC_LCTL, KC_LGUI, TD(ALT_OSL1),                     KC_SPC,         KC_RALT,MO(1),   KC_NO,   KC_LEFT,  KC_DOWN, KC_RIGHT),
  ...
  [1] = LAYOUT_soldered(
      ...
      KC_LSFT, KC_LSFT, KC_MPRV, KC_MPLY, KC_MNXT,KC_NO,  BL_TOGG,KC_NO,  KC_MUTE,KC_VOLD, KC_VOLU, KC_NO,    KC_RSFT, RGB_MOD,  KC_END,    \
      KC_LCTL, KC_LGUI, TD(ALT_OSL1),                     RESET,          KC_RCTL,KC_TRNS, KC_NO,   KC_HOME, BL_STEP,  KC_END)
