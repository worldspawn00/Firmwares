...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [5] = LAYOUT_ortho_3x10(
    KC_CALC, KC_WHOM, KC_MAIL, KC_MYCM, RGB_TOG, RGB_HUI, RGB_SAI, RGB_SPI, RGB_VAI, KC_PSCR,
    _______, _______, _______, _______, RGB_MOD, RGB_HUD, RGB_SAD, RGB_SPD, RGB_VAD, _______,
