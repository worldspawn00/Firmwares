...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT( /* Base */
    ...
    KC_LCTL, KC_LGUI,  LALT_LG,          KC_SPC,  FN,                        KC_SPC,           RALT_RG, KC_RCTL,          KC_LEFT, KC_DOWN, KC_RGHT           \
  ),
  ...
  [_FN] = LAYOUT(
    ...
    _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, _______, _______, _______, KC_APP,  _______,          _______,                   \
  ...
  [_ADJUST] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, RESET,   _______, _______, _______, _______, _______, _______, _______,          KC_VOLU,                   \
